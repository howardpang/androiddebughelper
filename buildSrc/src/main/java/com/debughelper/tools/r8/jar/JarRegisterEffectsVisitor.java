...
public class JarRegisterEffectsVisitor extends MethodVisitor {
  ...
  private final com.debughelper.tools.r8.graph.UseRegistry registry;
  private final com.debughelper.tools.r8.graph.JarApplicationReader application;

  public JarRegisterEffectsVisitor(com.debughelper.tools.r8.graph.DexType clazz, UseRegistry registry,
  ...
  public void visitTypeInsn(int opcode, String name) {
    com.debughelper.tools.r8.graph.DexType type = application.getTypeFromName(name);
