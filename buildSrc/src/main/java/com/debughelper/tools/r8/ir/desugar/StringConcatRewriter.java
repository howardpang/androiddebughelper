...
public class StringConcatRewriter {
  ...
  private void rewriteMakeConcat(DexMethod method, IRCode code, ListIterator<BasicBlock> blocks,
    ...
    List<com.debughelper.tools.r8.ir.code.Value> arguments = invokeCustom.inValues();
  ...
  private void rewriteMakeConcatWithConstants(
    ...
    DexType[] parameters = proto.parameters.values;
    int paramCount = parameters.length;
    List<com.debughelper.tools.r8.ir.code.Value> callArgs = invokeCustom.inValues();
  ...
  private final class ConcatBuilder {
    ...
    final void addChunk(com.debughelper.tools.r8.ir.code.Value value, DexMethod method) {
    ...
    final void desugar() {
      ...
      // new-instance v0, StringBuilder
      com.debughelper.tools.r8.ir.code.Value sbInstance = code.createValue(ValueType.OBJECT);
      ...
      com.debughelper.tools.r8.ir.code.Value concatValue = invokeCustom.outValue();
      if (concatValue == null) {
      ...
      instructions.replaceCurrentInstruction(new com.debughelper.tools.r8.ir.code.InvokeVirtual(
    ...
    private abstract class Chunk {
      ...
      abstract com.debughelper.tools.r8.ir.code.Value getOrCreateValue();

      final void addAppendCall(com.debughelper.tools.r8.ir.code.Value sbInstance) {
    ...
    private final class ArgumentChunk extends Chunk {
      ...
      ArgumentChunk(com.debughelper.tools.r8.ir.code.Value value, DexMethod method) {
        super(method);
        this.value = value;
      }

      @Override
      com.debughelper.tools.r8.ir.code.Value getOrCreateValue() {
        return value;
      }
    }
