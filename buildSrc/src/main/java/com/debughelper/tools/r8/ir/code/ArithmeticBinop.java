...
public abstract class ArithmeticBinop extends Binop {
  ...
  public ArithmeticBinop(com.debughelper.tools.r8.ir.code.NumericType type, Value dest, Value left, Value right) {
    super(type, dest, left, right);
  }

  public abstract com.debughelper.tools.r8.code.Instruction CreateInt(int dest, int left, int right);
  ...
  public boolean canBeFolded() {
    return (type == com.debughelper.tools.r8.ir.code.NumericType.INT || type == com.debughelper.tools.r8.ir.code.NumericType.LONG || type == com.debughelper.tools.r8.ir.code.NumericType.FLOAT
            || type == com.debughelper.tools.r8.ir.code.NumericType.DOUBLE)
  ...
  public LatticeElement evaluate(IRCode code, Function<Value, LatticeElement> getLatticeElement) {
    ...
    if (leftLattice.isConst() && rightLattice.isConst()) {
      ...
      } else if (type == com.debughelper.tools.r8.ir.code.NumericType.LONG) {
