...
public abstract class Format3rc extends Base3Format {
  ...
  Format3rc(int high, BytecodeStream stream, com.debughelper.tools.r8.graph.IndexedDexItem[] map) {
    super(stream);
    this.AA = (short) high;
  ...
  Format3rc(int firstArgumentRegister, int argumentCount, com.debughelper.tools.r8.graph.IndexedDexItem dexItem) {
