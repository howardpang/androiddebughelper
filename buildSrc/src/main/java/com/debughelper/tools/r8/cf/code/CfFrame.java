...
public class CfFrame extends CfInstruction {
  ...
  public abstract static class FrameType {
    ...
    public static FrameType uninitializedNew(com.debughelper.tools.r8.cf.code.CfLabel label) {
    ...
    public com.debughelper.tools.r8.cf.code.CfLabel getUninitializedLabel() {
      return null;
    }
  ...
  private static class UninitializedNew extends FrameType {
    ...
    private UninitializedNew(com.debughelper.tools.r8.cf.code.CfLabel label) {
      this.label = label;
    }
