...
public class BisectOptions {
  ...
  public static BisectOptions parse(String[] args) throws IOException {
    ...
    if (options.has(parser.resultBad)) {
      if (result == Result.GOOD) {
        throw new com.debughelper.tools.r8.errors.CompilationError("Cannot specify --" + RESULT_GOOD_FLAG
  ...
  private static <T> T require(OptionSet options, OptionSpec<T> option, String flag) {
    ...
    throw new com.debughelper.tools.r8.errors.CompilationError("Missing required option: --" + flag);
  }
  ...
  private static File exists(String path, String flag) {
    ...
    throw new com.debughelper.tools.r8.errors.CompilationError("File --" + flag + ": " + file + " does not exist");
  }
