...
public abstract class Instruction {
  ...
  Instruction(com.debughelper.tools.r8.code.BytecodeStream stream) {
  ...
  static byte readSigned8BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
    return (byte) stream.nextByte();
  }

  static short read8BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
    return (short) stream.nextByte();
  }

  static short readSigned16BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
    // Convert to signed.
    return (short) stream.nextShort();
  }

  static char read16BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
    return (char) (stream.nextShort() & 0xffff);
  }

  static int readSigned32BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
  ...
  static long read32BitValue(com.debughelper.tools.r8.code.BytecodeStream stream) {
  ...
  protected void write16BitReference(com.debughelper.tools.r8.graph.IndexedDexItem item, ShortBuffer dest,
  ...
  protected void write32BitReference(com.debughelper.tools.r8.graph.IndexedDexItem item, ShortBuffer dest,
                                     com.debughelper.tools.r8.graph.ObjectToOffsetMapping mapping) {
  ...
  static String formatOffset(int offset) {
    return com.debughelper.tools.r8.utils.StringUtils.hexString(offset, 2);
  }
  ...
  String formatString(String left) {
    ...
    com.debughelper.tools.r8.utils.StringUtils.appendLeftPadded(builder, formatOffset(getOffset()), 6);
    builder.append(": ");
    com.debughelper.tools.r8.utils.StringUtils.appendRightPadded(builder, getName(), 20);
  ...
  public String toSmaliString(Instruction payloadUser) {
    throw new com.debughelper.tools.r8.errors.InternalCompilerError("Instruction " + payloadUser + " is not a payload user");
  }

  public abstract String toSmaliString(com.debughelper.tools.r8.naming.ClassNameMapper naming);

  public String toSmaliString() {
    return toSmaliString((com.debughelper.tools.r8.naming.ClassNameMapper) null);
  }

  public abstract String toString(com.debughelper.tools.r8.naming.ClassNameMapper naming);
