...
import com.debughelper.tools.r8.utils.ArrayUtils;
...
public class ProguardMapApplier {
  ...
  class MapToLenseConverter {
    ...
    private void applyMemberMapping(DexType from, ChainedClassNaming classNaming) {
      ...
      final Set<com.debughelper.tools.r8.naming.MemberNaming> appliedMemberNaming = Sets.newIdentityHashSet();
      clazz.forEachField(encodedField -> {
        com.debughelper.tools.r8.naming.MemberNaming memberNaming = classNaming.lookupByOriginalItem(encodedField.field);
      ...
      clazz.forEachMethod(encodedMethod -> {
        com.debughelper.tools.r8.naming.MemberNaming memberNaming = classNaming.lookupByOriginalItem(encodedMethod.method);
        if (memberNaming != null) {
          appliedMemberNaming.add(memberNaming);
    ...
    private void applyFieldMapping(DexField originalField, com.debughelper.tools.r8.naming.MemberNaming memberNaming) {
    ...
    private void applyMethodMapping(DexMethod originalMethod, com.debughelper.tools.r8.naming.MemberNaming memberNaming) {
    ...
    private DexType applyClassMappingOnTheFly(DexType from) {
      if (seedMapper.hasMapping(from)) {
        ...
        com.debughelper.tools.r8.naming.ClassNamingForMapApplier classNaming = seedMapper.getClassNaming(from);
  ...
  static class ChainedClassNaming extends com.debughelper.tools.r8.naming.ClassNamingForMapApplier {
