...
import com.debughelper.tools.r8.code.Format11n;
...
public class Const4 extends com.debughelper.tools.r8.code.Format11n implements SingleConstant {
  ...
  public String toString(com.debughelper.tools.r8.naming.ClassNameMapper naming) {
    return formatString("v" + A + ", " + com.debughelper.tools.r8.utils.StringUtils.hexString(decodedValue(), 1) +
        " (" + decodedValue() + ")");
  }
