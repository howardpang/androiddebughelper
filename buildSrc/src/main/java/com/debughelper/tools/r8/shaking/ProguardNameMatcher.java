...
public abstract class ProguardNameMatcher {
  ...
  public static ProguardNameMatcher create(
      ProguardConfigurationParser.IdentifierPatternWithWildcards identifierPatternWithWildcards) {
  ...
  private static boolean matchFieldOrMethodNameImpl(
    ...
    ProguardWildcard.Pattern wildcardPattern;
    ProguardWildcard.BackReference backReference;
  ...
  private static class MatchNamePattern extends ProguardNameMatcher {
    ...
    protected MatchNamePattern materialize() {
      ...
      ProguardConfigurationParser.IdentifierPatternWithWildcards identifierPatternWithMaterializedWildcards =
          new ProguardConfigurationParser.IdentifierPatternWithWildcards(pattern, materializedWildcards);
