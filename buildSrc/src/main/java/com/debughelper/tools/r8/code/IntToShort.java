...
public class IntToShort extends com.debughelper.tools.r8.code.Format12x {
  ...
  public void buildIR(IRBuilder builder) {
    builder.addConversion(com.debughelper.tools.r8.ir.code.NumericType.SHORT, NumericType.INT, A, B);
  }
}
