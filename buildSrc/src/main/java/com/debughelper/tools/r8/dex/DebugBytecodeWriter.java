...
public class DebugBytecodeWriter {
  ...
  private final com.debughelper.tools.r8.graph.DexDebugInfo info;
  ...
  public byte[] generate() {
    ...
    for (com.debughelper.tools.r8.graph.DexString name : info.parameters) {
      putString(name);
    }
    // Body.
  ...
  public void putSleb128(int item) {
    byte[] encoded = com.debughelper.tools.r8.utils.LebUtils.encodeSleb128(item);
