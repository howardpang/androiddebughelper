...
public class IntToFloat extends com.debughelper.tools.r8.code.Format12x {
  ...
  public void buildIR(IRBuilder builder) {
    builder.addConversion(com.debughelper.tools.r8.ir.code.NumericType.FLOAT, NumericType.INT, A, B);
  }
}
