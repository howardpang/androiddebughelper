...
public class InvokeInterfaceRange extends Format3rc {
  ...
  public InvokeInterfaceRange(int firstArgumentRegister, int argumentCount, com.debughelper.tools.r8.graph.DexMethod method) {
  ...
  public void buildIR(IRBuilder builder) {
    builder.addInvokeRange(Invoke.Type.INTERFACE, getMethod(), getProto(), AA, CCCC);
  }
