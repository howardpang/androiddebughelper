...
public class FillArrayDataPayload extends Nop {
  ...
  public String toSmaliString(ClassNameMapper naming) {
    ...
    builder.append(com.debughelper.tools.r8.utils.StringUtils.hexString(element_width, 1));
    builder.append("  # ");
    ...
    if (element_width == 1) {
      ...
      for (int i = 0; i < data.length; i++) {
        for (int j = 0; j < 2; j++) {
          ...
          if (i * 2 + j < size) {
            builder.append("      ");
            builder.append(com.debughelper.tools.r8.utils.StringUtils.hexString(value, 2));
            builder.append("  # ");
