...
public class JarDiff {
  ...
  private com.debughelper.tools.r8.ArchiveClassFileProvider archive1;
  private com.debughelper.tools.r8.ArchiveClassFileProvider archive2;
  ...
  public void run() throws Exception {
    archive1 = new com.debughelper.tools.r8.ArchiveClassFileProvider(path1);
    archive2 = new com.debughelper.tools.r8.ArchiveClassFileProvider(path2);
  ...
  private List<String> getSortedDescriptorList(com.debughelper.tools.r8.ArchiveClassFileProvider inputJar) {
  ...
  private static List<String> getInstructionStrings(DexEncodedMethod method) {
    List<com.debughelper.tools.r8.cf.code.CfInstruction> instructions = method.getCode().asCfCode().getInstructions();
