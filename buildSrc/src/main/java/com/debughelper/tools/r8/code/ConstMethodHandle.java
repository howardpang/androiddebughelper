...
public class ConstMethodHandle extends Format21c {
  ...
  public ConstMethodHandle(int register, com.debughelper.tools.r8.graph.DexMethodHandle methodHandle) {
    super(register, methodHandle);
  }

  public com.debughelper.tools.r8.graph.DexMethodHandle getMethodHandle() {
    return (com.debughelper.tools.r8.graph.DexMethodHandle) BBBB;
  }
