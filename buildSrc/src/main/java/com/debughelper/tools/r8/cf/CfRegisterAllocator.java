 ...
 * com.debughelper.tools.r8.ir.regalloc.LinearScanRegisterAllocator} since for CF there are no register
...
public class CfRegisterAllocator implements RegisterAllocator {
  ...
  public int getRegisterForValue(com.debughelper.tools.r8.ir.code.Value value) {
  ...
  private void computeNeedsRegister() {
    ...
    while (it.hasNext()) {
      ...
      com.debughelper.tools.r8.ir.code.Value outValue = next.outValue();
      if (outValue != null) {
  ...
  public void addToLiveAtEntrySet(com.debughelper.tools.r8.ir.code.BasicBlock block, Collection<Phi> phis) {
