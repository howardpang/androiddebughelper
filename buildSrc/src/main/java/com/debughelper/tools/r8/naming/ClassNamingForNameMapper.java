 ...
 */
public class ClassNamingForNameMapper implements com.debughelper.tools.r8.naming.ClassNaming {
  ...
  public List<com.debughelper.tools.r8.naming.MemberNaming> lookupByOriginalName(String originalName) {
    List<com.debughelper.tools.r8.naming.MemberNaming> result = new ArrayList<>();
