...
public class LazyLoadedDexApplication extends com.debughelper.tools.r8.graph.DexApplication {

  private final com.debughelper.tools.r8.utils.ClasspathClassCollection classpathClasses;
  private final com.debughelper.tools.r8.utils.LibraryClassCollection libraryClasses;
  ...
  private LazyLoadedDexApplication(ClassNameMapper proguardMap,
                                   ...
                                   com.debughelper.tools.r8.utils.ClasspathClassCollection classpathClasses,
                                   com.debughelper.tools.r8.utils.LibraryClassCollection libraryClasses,
                                   ImmutableSet<com.debughelper.tools.r8.graph.DexType> mainDexList, String deadCode,
                                   com.debughelper.tools.r8.graph.DexItemFactory dexItemFactory, DexString highestSortingString,
  ...
  @Override
  public com.debughelper.tools.r8.graph.DexClass definitionFor(com.debughelper.tools.r8.graph.DexType type) {
    if (type == null) {
      return null;
    }
    com.debughelper.tools.r8.graph.DexClass clazz = programClasses.get(type);
  ...
  private Map<com.debughelper.tools.r8.graph.DexType, com.debughelper.tools.r8.graph.DexClass> forceLoadAllClasses() {
    Map<com.debughelper.tools.r8.graph.DexType, com.debughelper.tools.r8.graph.DexClass> loaded = new IdentityHashMap<>();
  ...
  public static class Builder extends DexApplication.Builder<Builder> {
    ...
    private com.debughelper.tools.r8.utils.ClasspathClassCollection classpathClasses;
    private com.debughelper.tools.r8.utils.LibraryClassCollection libraryClasses;
    ...
    private Builder(LazyLoadedDexApplication application) {
      super(application);
      this.resolver = com.debughelper.tools.r8.utils.ProgramClassCollection::resolveClassConflictImpl;
  ...
  @Override
  public com.debughelper.tools.r8.graph.DirectMappedDexApplication toDirect() {
