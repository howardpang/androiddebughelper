...
public class JarState {
  ...
  private static class LocalNodeInfo {
    ...
    final com.debughelper.tools.r8.graph.DebugLocalInfo info;

    LocalNodeInfo(LocalVariableNode node, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      this.node = node;
      this.info = info;
  ...
  private static class LocalsAtOffset {
    ...
    IdentityHashMap<com.debughelper.tools.r8.graph.DebugLocalInfo, com.debughelper.tools.r8.graph.DebugLocalInfo> liveInfosCache = null;
    ...
    void addStart(LocalVariableNode node, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      starts.add(new LocalNodeInfo(node, info));
    }

    void addEnd(LocalVariableNode node, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      ends.add(new LocalNodeInfo(node, info));
    }

    void addLive(LocalVariableNode node, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      assert liveInfosCache == null;
      live.add(new LocalNodeInfo(node, info));
    }

    boolean isLive(com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      if (live.size() < 10) {
  ...
  public static class Local {
    ...
    public Local(Slot slot, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
      this.slot = slot;
      this.info = info;
    }
  }
  ...
  private final Map<Equivalence.Wrapper<LocalVariableNode>, com.debughelper.tools.r8.graph.DebugLocalInfo> canonicalLocalInfo;
  ...
  public JarState(int maxLocals, List localNodes, com.debughelper.tools.r8.ir.conversion.JarSourceCode source, com.debughelper.tools.r8.graph.JarApplicationReader application) {
    ...
    if (localNodes.size() == 0) {
      ...
      com.debughelper.tools.r8.graph.DebugLocalInfo info = createLocalInfo(local, application);
      ...
      for (Object o : localNodes) {
        ...
        com.debughelper.tools.r8.graph.DebugLocalInfo info = canonicalLocalInfo.get(wrapped);
        if (info == null) {
  ...
  private static com.debughelper.tools.r8.graph.DebugLocalInfo createLocalInfo(
      LocalVariableNode node,
      JarApplicationReader application) {
    return new com.debughelper.tools.r8.graph.DebugLocalInfo(
  ...
  private void populateLocalsAtTable(
          LocalVariableNode node, com.debughelper.tools.r8.graph.DebugLocalInfo info, com.debughelper.tools.r8.ir.conversion.JarSourceCode source) {
    ...
    if (start == -1 || end == -1) {
      throw new com.debughelper.tools.r8.errors.InvalidDebugInfoException(
  ...
  private List<com.debughelper.tools.r8.utils.Pair<Integer, Type>> writes = new ArrayList<>();
  ...
  private void applyWrites() {
    for (com.debughelper.tools.r8.utils.Pair<Integer, Type> write : writes) {
  ...
  public com.debughelper.tools.r8.graph.DebugLocalInfo getIncomingLocalInfoForRegister(int register) {
  ...
  public com.debughelper.tools.r8.graph.DebugLocalInfo getOutgoingLocalInfoForRegister(int register) {
    com.debughelper.tools.r8.graph.DebugLocalInfo local = getIncomingLocalInfoForRegister(register);
  ...
  private Local setLocal(int index, Type type, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
    return setLocalForRegister(getLocalRegister(index, type), type, info);
  }

  private Local setLocalForRegister(int register, Type type, com.debughelper.tools.r8.graph.DebugLocalInfo info) {
  ...
  private void openLocal(Local localToOpen) {
    ...
    com.debughelper.tools.r8.graph.DebugLocalInfo info = localToOpen.info;
    Local local = getLocalForRegister(register);
