...
package com.debughelper.tools.r8.shaking.protolite;
...
import com.debughelper.tools.r8.shaking.protolite.ProtoLiteBase;
 ...
 */
public class ProtoLitePruner extends com.debughelper.tools.r8.shaking.protolite.ProtoLiteBase {
  ...
  private boolean isDefinedAsNull(com.debughelper.tools.r8.ir.code.Value value) {
  ...
  public void rewriteProtoLiteSpecialMethod(com.debughelper.tools.r8.ir.code.IRCode code, DexEncodedMethod method) {
   ...
   */
  private void rewriteConstructor(com.debughelper.tools.r8.ir.code.IRCode code) {
   ...
   * write methods above.
   */
  private void rewriteSizeOrWriteMethod(com.debughelper.tools.r8.ir.code.IRCode code) {
    boolean wasRewritten;
    do {
      wasRewritten = false;
      com.debughelper.tools.r8.ir.code.InstructionIterator it = code.instructionIterator();
      while (it.hasNext()) {
        ...
        if (insn.isInstanceGet()) {
          ...
          com.debughelper.tools.r8.ir.code.InvokeMethodWithReceiver invokeMethod = insn.asInvokeMethodWithReceiver();
          ...
          if (isDeadProtoGetter(invokedMethod)) {
            ...
            com.debughelper.tools.r8.ir.code.Value receiver = invokeMethod.getReceiver();
            ...
            com.debughelper.tools.r8.ir.code.Value lastArg = Iterables.getLast(invokeMethod.inValues());
            if (isDefinedAsNull(lastArg)) {
              it.remove();
            }
          }
        } else if (insn.isInvokeMethod()) {
          com.debughelper.tools.r8.ir.code.InvokeMethod invokeMethod = insn.asInvokeMethod();
          DexMethod invokedMethod = invokeMethod.getInvokedMethod();
   ...
   * </dl>
   */
  private void rewriteDynamicMethod(com.debughelper.tools.r8.ir.code.IRCode code, DexEncodedMethod method) {
    ...
    com.debughelper.tools.r8.ir.code.Instruction matchingInstr = iterator.nextUntil(com.debughelper.tools.r8.ir.code.Instruction::isSwitch);
    if (matchingInstr == null) {
      throw new CompilationError("dynamicMethod in protoLite without switch.");
    }
    com.debughelper.tools.r8.ir.code.Switch switchInstr = matchingInstr.asSwitch();
    ...
    com.debughelper.tools.r8.ir.code.BasicBlock initializedCase = null;
    com.debughelper.tools.r8.ir.code.BasicBlock visitCase = null;
    com.debughelper.tools.r8.ir.code.BasicBlock mergeCase = null;
    com.debughelper.tools.r8.ir.code.BasicBlock makeImmutableCase = null;
   ...
   */
  private void rewriteMakeImmutableCase(com.debughelper.tools.r8.ir.code.BasicBlock switchCase, com.debughelper.tools.r8.ir.code.IRCode code) {
    com.debughelper.tools.r8.ir.code.DominatorTree dom = new com.debughelper.tools.r8.ir.code.DominatorTree(code);
    boolean wasRewritten;
    do {
      wasRewritten = false;
      for (com.debughelper.tools.r8.ir.code.BasicBlock current : dom.dominatedBlocks(switchCase)) {
        com.debughelper.tools.r8.ir.code.InstructionIterator it = current.iterator();
        while (it.hasNext()) {
          com.debughelper.tools.r8.ir.code.Instruction insn = it.next();
   ...
   */
  private void rewriteIsInitializedCase(com.debughelper.tools.r8.ir.code.BasicBlock switchCase, DexType instanceType,
          ...
          if (insn.isInvokeMethodWithReceiver()) {
            ...
            if (isDeadProtoGetter(invokedMethod)) {
              ...
              if (appInfo.withLiveness().liveFields.contains(field)) {
                ...
                com.debughelper.tools.r8.ir.code.Value thisReference = invokeMethod.getReceiver();
                com.debughelper.tools.r8.ir.code.Value newResult = code.createValue(com.debughelper.tools.r8.ir.code.ValueType.INT);
                invokeMethod.outValue().replaceUsers(newResult);
                com.debughelper.tools.r8.ir.code.Value theList = code.createValue(ValueType.OBJECT);
                it.replaceCurrentInstruction(
                    new com.debughelper.tools.r8.ir.code.InstanceGet(MemberType.OBJECT, theList, thisReference, field));
  ...
  private com.debughelper.tools.r8.ir.code.InstancePut findProtoFieldWrite(com.debughelper.tools.r8.ir.code.BasicBlock block, DexType instanceType,
                                                                           BiPredicate<DexField, DexType> filter, com.debughelper.tools.r8.ir.code.DominatorTree dom) {
    for (com.debughelper.tools.r8.ir.code.BasicBlock current : dom.dominatedBlocks(block)) {
      com.debughelper.tools.r8.ir.code.InstructionIterator insns = current.iterator();
      com.debughelper.tools.r8.ir.code.InstancePut instancePut = (com.debughelper.tools.r8.ir.code.InstancePut) insns.nextUntil(com.debughelper.tools.r8.ir.code.Instruction::isInstancePut);
   ...
   */
  private void rewriteMergeCase(com.debughelper.tools.r8.ir.code.BasicBlock caseBlock, DexType instanceType,
                                com.debughelper.tools.r8.ir.code.IRCode code) {
    // We are looking for a switch statement over the input tag. Just traverse all blocks until
    // we find it.
    List<com.debughelper.tools.r8.ir.code.BasicBlock> deadBlocks = new ArrayList<>();
    com.debughelper.tools.r8.ir.code.DominatorTree dom = new com.debughelper.tools.r8.ir.code.DominatorTree(code);
    for (com.debughelper.tools.r8.ir.code.BasicBlock current : dom.dominatedBlocks(caseBlock)) {
      com.debughelper.tools.r8.ir.code.InstructionIterator it = current.iterator();
      com.debughelper.tools.r8.ir.code.Switch switchInstr = (com.debughelper.tools.r8.ir.code.Switch) it.nextUntil(com.debughelper.tools.r8.ir.code.Instruction::isSwitch);
      if (switchInstr != null) {
        int nextBlock = code.getHighestBlockNumber() + 1;
        IntList liveKeys = new IntArrayList(switchInstr.numberOfKeys());
        List<com.debughelper.tools.r8.ir.code.BasicBlock> liveBlocks = new ArrayList<>(switchInstr.numberOfKeys());
        boolean needsCleanup = false;
        // Filter out all the cases that contain writes to dead fields.
        for (int keyIdx = 0; keyIdx < switchInstr.numberOfKeys(); keyIdx++) {
          com.debughelper.tools.r8.ir.code.BasicBlock targetBlock = switchInstr.targetBlock(keyIdx);
          com.debughelper.tools.r8.ir.code.InstancePut instancePut =
          ...
          if (instancePut == null
            ...
            if (bitFieldUpdate != null) {
              com.debughelper.tools.r8.ir.code.BasicBlock newBlock = com.debughelper.tools.r8.ir.code.BasicBlock.createGotoBlock(nextBlock++);
        ...
        if (needsCleanup) {
          com.debughelper.tools.r8.ir.code.DominatorTree updatedTree = new com.debughelper.tools.r8.ir.code.DominatorTree(code);
          com.debughelper.tools.r8.ir.code.BasicBlock fallThrough = switchInstr.fallthroughBlock();
          List<com.debughelper.tools.r8.ir.code.BasicBlock> successors = ImmutableList.copyOf(current.getNormalSuccessors());
          ...
          com.debughelper.tools.r8.ir.code.Switch newSwitch = new Switch(switchInstr.inValues().get(0), liveKeys.toIntArray(),
  ...
  private void moveInstructionTo(InstructionListIterator iterator, com.debughelper.tools.r8.ir.code.Instruction insn,
                                 com.debughelper.tools.r8.ir.code.DominatorTree dom,
                                 com.debughelper.tools.r8.ir.code.BasicBlock dominator) {
    for (com.debughelper.tools.r8.ir.code.Value value : insn.inValues()) {
      com.debughelper.tools.r8.ir.code.Instruction input = value.definition;
  ...
  private boolean isVisitOfDeadField(com.debughelper.tools.r8.ir.code.Instruction instruction) {
    ...
    if (invokeMethod.getInvokedMethod().getHolder() == visitorType
      ...
      com.debughelper.tools.r8.ir.code.Instruction secondArg = invokeMethod.inValues().get(2).definition;
   ...
   */
  private void rewriteVisitCase(com.debughelper.tools.r8.ir.code.BasicBlock switchCase, IRCode code) {
    com.debughelper.tools.r8.ir.code.DominatorTree dom = new DominatorTree(code);
    boolean wasRewritten;
    do {
      wasRewritten = false;
