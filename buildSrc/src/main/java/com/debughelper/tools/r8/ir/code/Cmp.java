...
import com.debughelper.tools.r8.code.CmpLong;
import com.debughelper.tools.r8.code.CmpgDouble;
import com.debughelper.tools.r8.code.CmpgFloat;
import com.debughelper.tools.r8.code.CmplDouble;
import com.debughelper.tools.r8.code.CmplFloat;
...
public class Cmp extends Binop {
  ...
  public Cmp(com.debughelper.tools.r8.ir.code.NumericType type, Bias bias, Value dest, Value left, Value right) {
  ...
  private boolean nonOverlapingRanges() {
    return type == com.debughelper.tools.r8.ir.code.NumericType.LONG
  ...
  @Override
  public LatticeElement evaluate(com.debughelper.tools.r8.ir.code.IRCode code, Function<Value, LatticeElement> getLatticeElement) {
    ...
    if (leftLattice.isConst() && rightLattice.isConst()) {
      ...
      int result;
      if (type == com.debughelper.tools.r8.ir.code.NumericType.LONG) {
        result = Integer.signum(Long.compare(leftConst.getLongValue(), rightConst.getLongValue()));
      } else if (type == com.debughelper.tools.r8.ir.code.NumericType.FLOAT) {
