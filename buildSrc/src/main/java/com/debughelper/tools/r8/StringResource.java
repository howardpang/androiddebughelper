...
public interface StringResource extends Resource {
   ...
   * @throws com.debughelper.tools.r8.ResourceException Exception thrown if the resource fails to produce its content.
   */
  String getString() throws com.debughelper.tools.r8.ResourceException;
  ...
  class StringContentResource implements StringResource {
    ...
    @Override
    public String getString() throws com.debughelper.tools.r8.ResourceException {
      return content;
    }
  }
