...
public class CfState {
  ...
  private abstract static class SlotType {
    ...
    public abstract com.debughelper.tools.r8.graph.DexType getPrecise();

    public abstract com.debughelper.tools.r8.ir.code.ValueType getImprecise();

    private static class Precise extends SlotType {
      private final com.debughelper.tools.r8.graph.DexType type;

      Precise(com.debughelper.tools.r8.graph.DexType type) {
        this.type = type;
      }

      @Override
      public com.debughelper.tools.r8.graph.DexType getPrecise() {
        return type;
      }

      @Override
      public com.debughelper.tools.r8.ir.code.ValueType getImprecise() {
        return com.debughelper.tools.r8.ir.code.ValueType.fromDexType(type);
      }
    ...
    private static class Imprecise extends SlotType {
      ...
      Imprecise(com.debughelper.tools.r8.ir.code.ValueType type) {
        this.type = type;
      }
  ...
  public CfState(com.debughelper.tools.r8.origin.Origin origin) {
    this.origin = origin;
  }
  ...
  public void setStateFromFrame(com.debughelper.tools.r8.graph.DexType[] locals, com.debughelper.tools.r8.graph.DexType[] stack, com.debughelper.tools.r8.ir.code.Position position) {
  ...
  public static Snapshot merge(Snapshot current, Snapshot update, com.debughelper.tools.r8.origin.Origin origin) {
    assert update != null;
    if (current == null) {
      return update;
    }
  ...
  private static Snapshot merge(BaseSnapshot current, BaseSnapshot update, Origin origin) {
    ...
    for (int i = 0; i < current.stack.length; i++) {
      com.debughelper.tools.r8.ir.code.ValueType currentType = current.stack[i].getImprecise();
      com.debughelper.tools.r8.ir.code.ValueType updateType = update.stack[i].getImprecise();
  ...
  public Slot push(com.debughelper.tools.r8.graph.DexType type) {
    return push(new SlotType.Precise(type));
  }

  public Slot push(com.debughelper.tools.r8.ir.code.ValueType type) {
  ...
  public Slot write(int localIndex, com.debughelper.tools.r8.graph.DexType type) {
  ...
  public com.debughelper.tools.r8.ir.code.Position getPosition() {
    return current.getPosition();
  }

  public void setPosition(com.debughelper.tools.r8.ir.code.Position position) {
  ...
  public static class Slot {
    ...
    public final com.debughelper.tools.r8.ir.code.ValueType type;
    public final com.debughelper.tools.r8.graph.DexType preciseType;
    private final SlotType slotType;

    private Slot(int register, com.debughelper.tools.r8.graph.DexType preciseType) {
  ...
  public abstract static class Snapshot {
    ...
    public Snapshot exceptionTransfer(com.debughelper.tools.r8.graph.DexType throwableType) {
  ...
  private static class BaseSnapshot extends Snapshot {
    ...
    final com.debughelper.tools.r8.ir.code.Position position;

    BaseSnapshot() {
      this(0, 0, com.debughelper.tools.r8.ir.code.Position.none());
    }

    BaseSnapshot(int locals, int stack, com.debughelper.tools.r8.ir.code.Position position) {
      super(null, 0);
      assert position != null;
    ...
    BaseSnapshot(com.debughelper.tools.r8.graph.DexType[] locals, com.debughelper.tools.r8.graph.DexType[] stack, com.debughelper.tools.r8.ir.code.Position position) {
      super(null, 0);
      assert position != null;
  ...
  private static class SetPosition extends Snapshot {
    ...
    SetPosition(Snapshot parent, com.debughelper.tools.r8.ir.code.Position position) {
      super(parent, parent.updates + 1);
      this.position = position;
    }
