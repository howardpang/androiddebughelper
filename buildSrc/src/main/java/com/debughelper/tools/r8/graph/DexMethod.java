...
public class DexMethod extends Descriptor<com.debughelper.tools.r8.graph.DexEncodedMethod, DexMethod>
    implements PresortedComparable<DexMethod> {

  public final com.debughelper.tools.r8.graph.DexType holder;
  public final com.debughelper.tools.r8.graph.DexProto proto;
  public final DexString name;

  // Caches used during processing.
  private Map<com.debughelper.tools.r8.graph.DexType, com.debughelper.tools.r8.graph.DexEncodedMethod> singleTargetCache;

  DexMethod(com.debughelper.tools.r8.graph.DexType holder, DexProto proto, DexString name, boolean skipNameValidationForTesting) {
    this.holder = holder;
    this.proto = proto;
    this.name = name;
  ...
  @Override
  public int slowCompareTo(DexMethod other, com.debughelper.tools.r8.naming.NamingLens namingLens) {
  ...
  @Override
  public boolean match(com.debughelper.tools.r8.graph.DexEncodedMethod entry) {
    return entry.method.name == name && entry.method.proto == proto;
  }

  @Override
  public com.debughelper.tools.r8.graph.DexType getHolder() {
    return holder;
  }
  ...
  synchronized public void setSingleVirtualMethodCache(
          com.debughelper.tools.r8.graph.DexType receiverType, com.debughelper.tools.r8.graph.DexEncodedMethod method) {
  ...
  synchronized public boolean isSingleVirtualMethodCached(com.debughelper.tools.r8.graph.DexType receiverType) {
