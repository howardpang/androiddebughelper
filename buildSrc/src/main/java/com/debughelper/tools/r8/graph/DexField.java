...
public class DexField extends Descriptor<com.debughelper.tools.r8.graph.DexEncodedField, DexField> implements
        PresortedComparable<DexField> {

  public final com.debughelper.tools.r8.graph.DexType clazz;
  public final com.debughelper.tools.r8.graph.DexType type;
  public final DexString name;

  DexField(com.debughelper.tools.r8.graph.DexType clazz, com.debughelper.tools.r8.graph.DexType type, DexString name, boolean skipNameValidationForTesting) {
    this.clazz = clazz;
    this.type = type;
    this.name = name;
  ...
  @Override
  public int slowCompareTo(DexField other, com.debughelper.tools.r8.naming.NamingLens namingLens) {
