...
public interface InstructionListIterator extends ListIterator<Instruction>,
   ...
   */
  BasicBlock split(com.debughelper.tools.r8.ir.code.IRCode code, ListIterator<BasicBlock> blockIterator);


  default BasicBlock split(com.debughelper.tools.r8.ir.code.IRCode code) {
  ...
  BasicBlock split(com.debughelper.tools.r8.ir.code.IRCode code, int instructions, ListIterator<BasicBlock> blockIterator);

  /**
   * See {@link #split(com.debughelper.tools.r8.ir.code.IRCode, int, ListIterator)}.
   */
  default BasicBlock split(com.debughelper.tools.r8.ir.code.IRCode code, int instructions) {
  ...
  BasicBlock inlineInvoke(com.debughelper.tools.r8.ir.code.IRCode code, com.debughelper.tools.r8.ir.code.IRCode inlinee, ListIterator<BasicBlock> blockIterator,
                          List<BasicBlock> blocksToRemove, DexType downcast);

  /**
   * See {@link #inlineInvoke(com.debughelper.tools.r8.ir.code.IRCode, com.debughelper.tools.r8.ir.code.IRCode, ListIterator, List, DexType)}.
   */
  default BasicBlock inlineInvoke(com.debughelper.tools.r8.ir.code.IRCode code, IRCode inlinee) {
