...
public interface PresortedComparable<T> extends Presorted, Comparable<T> {
  ...
  static <T extends PresortedComparable<T>> boolean isSorted(com.debughelper.tools.r8.graph.KeyedDexItem<T>[] items) {
  ...
  int slowCompareTo(T other, com.debughelper.tools.r8.naming.NamingLens namingLens);
