...
public interface SourceCode {
  ...
  com.debughelper.tools.r8.graph.DebugLocalInfo getIncomingLocal(int register);

  com.debughelper.tools.r8.graph.DebugLocalInfo getOutgoingLocal(int register);

  com.debughelper.tools.r8.ir.code.Position getCurrentPosition();
