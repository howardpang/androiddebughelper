...
public class DexOutputBuffer {
  ...
  public void putUleb128(int value) {
    com.debughelper.tools.r8.utils.LebUtils.putUleb128(this, value);
  }
  ...
  public int putSignedEncodedValue(long value, int expectedSize) {
    return com.debughelper.tools.r8.utils.EncodedValueUtils.putSigned(this, value, expectedSize);
  }
  ...
  public void putInstructions(com.debughelper.tools.r8.code.Instruction[] insns, ObjectToOffsetMapping mapping) {
    int size = 0;
