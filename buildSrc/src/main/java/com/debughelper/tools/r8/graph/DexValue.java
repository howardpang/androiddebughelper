...
import com.debughelper.tools.r8.dex.FileWriter;
...
public abstract class DexValue extends DexItem {
  ...
  public static DexValue fromAsmBootstrapArgument(
    ...
    if (value instanceof Integer) {
      ...
      switch (type.getSort()) {
        ...
        default:
          throw new com.debughelper.tools.r8.errors.Unreachable("Type sort is not supported: " + type.getSort());
      }
  ...
  public static DexValue defaultForType(DexType type) {
    switch (type.toShorty()) {
      ...
      default:
        throw new com.debughelper.tools.r8.errors.Unreachable("No default value for unexpected type " + type);
    }
  }
  ...
  public com.debughelper.tools.r8.ir.code.Instruction asConstInstruction(boolean hasClassInitializer, com.debughelper.tools.r8.ir.code.Value dest) {
    return null;
  }
  ...
  static public class DexValueByte extends SimpleDexValue {
    ...
    @Override
    public com.debughelper.tools.r8.ir.code.Instruction asConstInstruction(boolean hasClassInitializer, com.debughelper.tools.r8.ir.code.Value dest) {
      return (this == DEFAULT && hasClassInitializer) ? null : new com.debughelper.tools.r8.ir.code.ConstNumber(dest, value);
    }
  }
  ...
  static public class DexValueFloat extends SimpleDexValue {
    ...
    public void writeTo(DexOutputBuffer dest, ObjectToOffsetMapping mapping) {
      dest.forward(1);
      int length = com.debughelper.tools.r8.utils.EncodedValueUtils.putFloat(dest, value);
      dest.rewind(length + 1);
  ...
  static private abstract class NestedDexValue<T extends IndexedDexItem> extends DexValue {
    ...
    @Override
    public Object getBoxedValue() {
      throw new com.debughelper.tools.r8.errors.Unreachable("No boxed value for DexValue " + this.getClass().getSimpleName());
    }

    @Override
    public Object asAsmEncodedObject() {
      throw new com.debughelper.tools.r8.errors.Unreachable("No ASM conversion for DexValue " + this.getClass().getSimpleName());
    }
  ...
  static public class DexValueMethodType extends NestedDexValue<com.debughelper.tools.r8.graph.DexProto> {
  ...
  static public class DexValueArray extends DexValue {
    ...
    @Override
    public Object getBoxedValue() {
      throw new com.debughelper.tools.r8.errors.Unreachable("No boxed value for DexValueArray");
    }

    @Override
    public Object asAsmEncodedObject() {
      throw new com.debughelper.tools.r8.errors.Unreachable("No ASM conversion for DexValueArray");
    }
  ...
  static public class DexValueAnnotation extends DexValue {
    ...
    @Override
    public Object getBoxedValue() {
      throw new com.debughelper.tools.r8.errors.Unreachable("No boxed value for DexValueAnnotation");
    }
