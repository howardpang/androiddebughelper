 ...
 * {@link Origin} which is some opaque description of where the resource comes from. The D8Adapter/R8
 ...
 *
 * The D8Adapter/R8 compilers uses default implementations for various file-system resources, but the
