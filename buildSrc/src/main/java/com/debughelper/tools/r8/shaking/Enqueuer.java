...
import static com.debughelper.tools.r8.shaking.ProguardConfigurationUtils.buildIdentifierNameStringRule;
...
import com.debughelper.tools.r8.shaking.KeepReason;
...
import com.debughelper.tools.r8.shaking.RootSetBuilder.ConsequentRootSet;
import com.debughelper.tools.r8.shaking.RootSetBuilder.RootSet;
import com.debughelper.tools.r8.shaking.ScopedDexMethodSet;
...
public class Enqueuer {
  ...
  private final com.debughelper.tools.r8.shaking.protolite.ProtoLiteExtension protoLiteExtension;
   ...
   */
  private final com.debughelper.tools.r8.shaking.ProguardConfiguration.Builder compatibility;
  ...
  public Enqueuer(AppInfoWithSubtyping appInfo, InternalOptions options,
                  boolean forceProguardCompatibility,
                  ProguardConfiguration.Builder compatibility, com.debughelper.tools.r8.shaking.protolite.ProtoLiteExtension protoLiteExtension) {
  ...
  private void enqueueRootItem(Map.Entry<DexItem, ProguardKeepRule> root) {
    ...
    com.debughelper.tools.r8.shaking.KeepReason reason = com.debughelper.tools.r8.shaking.KeepReason.dueToKeepRule(root.getValue());
    if (item instanceof DexClass) {
      ...
      if (forceProguardCompatibility && clazz.hasDefaultInitializer()) {
        ...
        proguardCompatibilityWorkList.add(Action.markMethodLive(
            clazz.getDefaultInitializer(), com.debughelper.tools.r8.shaking.KeepReason.dueToProguardCompatibilityKeepRule(rule)));
      }
  ...
  private class UseRegistry extends com.debughelper.tools.r8.graph.UseRegistry {
    ...
    public boolean registerInvokeVirtual(DexMethod method) {
      if (appInfo.dexItemFactory.classMethods.isReflectiveMemberLookup(method)) {
        if (forceProguardCompatibility) {
          ...
          if (identifierNameStrings.add(method) && compatibility != null) {
            compatibility.addRule(ProguardConfigurationUtils.buildIdentifierNameStringRule(method));
          }
      ...
      workList.add(Action.markReachableVirtual(method, com.debughelper.tools.r8.shaking.KeepReason.invokedFrom(currentMethod)));
      return true;
    }
    ...
    public boolean registerInvokeDirect(DexMethod method) {
      ...
      handleInvokeOfDirectTarget(method, com.debughelper.tools.r8.shaking.KeepReason.invokedFrom(currentMethod));
      return true;
    }
    ...
    public boolean registerInvokeStatic(DexMethod method) {
      ...
      handleInvokeOfStaticTarget(method, com.debughelper.tools.r8.shaking.KeepReason.invokedFrom(currentMethod));
      return true;
    }
    ...
    public boolean registerInvokeInterface(DexMethod method) {
      ...
      workList.add(Action.markReachableInterface(method, com.debughelper.tools.r8.shaking.KeepReason.invokedFrom(currentMethod)));
      return true;
    }
    ...
    public boolean registerInstanceFieldWrite(DexField field) {
      ...
      workList.add(Action.markReachableField(field, com.debughelper.tools.r8.shaking.KeepReason.fieldReferencedIn(currentMethod)));
      return true;
    }
    ...
    public boolean registerStaticFieldRead(DexField field) {
      ...
      markStaticFieldAsLive(field, com.debughelper.tools.r8.shaking.KeepReason.fieldReferencedIn(currentMethod));
      return true;
    }
    ...
    if (liveTypes.add(type)) {
      ...
      if (!holder.isLibraryClass() && holder.hasNonTrivialClassInitializer()) {
        ...
        if (clinit != null) {
          ...
          markDirectStaticOrConstructorMethodAsLive(clinit, com.debughelper.tools.r8.shaking.KeepReason.reachableFromLiveType(type));
        }
      }
  ...
  private void handleInvokeOfStaticTarget(DexMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void handleInvokeOfDirectTarget(DexMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
    // We have to mark the resolved method as targeted even if it cannot actually be invoked
    // to make sure the invocation will keep failing in the appropriate way.
    ResolutionResult resolutionResult = appInfo.resolveMethod(method.holder, method);
    if (resolutionResult == null) {
  ...
  private void ensureFromLibraryOrThrow(DexType type, DexType context) {
    if (tracingMainDex) {
      // b/72312389: debughelper.jar contains parts of JUnit and most developers include JUnit in
  ...
  private void markMethodAsTargeted(DexEncodedMethod encodedMethod, com.debughelper.tools.r8.shaking.KeepReason reason) {
   ...
   */
  private void processNewlyInstantiatedClass(DexClass clazz, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void transitionMethodsForInstantiatedClass(DexType instantiatedType) {
    com.debughelper.tools.r8.shaking.ScopedDexMethodSet seen = new com.debughelper.tools.r8.shaking.ScopedDexMethodSet();
  ...
  private void transitionDefaultMethodsForInstantiatedClass(DexType iface, DexType instantiatedType,
      com.debughelper.tools.r8.shaking.ScopedDexMethodSet seen) {
    DexClass clazz = appInfo.definitionFor(iface);
  ...
  private void transitionNonAbstractMethodsToLiveAndShadow(Iterable<DexEncodedMethod> reachable,
      DexType instantiatedType, com.debughelper.tools.r8.shaking.ScopedDexMethodSet seen) {
      ...
      if (seen.addMethod(encodedMethod)) {
        ...
        if (!encodedMethod.accessFlags.isAbstract()) {
          markVirtualMethodAsLive(encodedMethod,
              com.debughelper.tools.r8.shaking.KeepReason.reachableFromLiveType(instantiatedType));
        }
      }
    }
  }
    ...
    do {
      ...
      if (reachableFields != null) {
        for (DexEncodedField field : reachableFields.getItems()) {
          markInstanceFieldAsLive(field, com.debughelper.tools.r8.shaking.KeepReason.reachableFromLiveType(type));
        }
      }
      type = clazz.superType;
    } while (type != null && !instantiatedTypes.contains(type));
  ...
  private void markStaticFieldAsLive(DexField field, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void markInstanceFieldAsLive(DexEncodedField field, com.debughelper.tools.r8.shaking.KeepReason reason) {
    assert field != null;
  ...
  private void markInstantiated(DexType type, DexEncodedMethod method) {
    ...
    workList.add(Action.markInstantiated(clazz, com.debughelper.tools.r8.shaking.KeepReason.instantiatedIn(method)));
  }

  private void markLambdaInstantiated(DexType itf, DexEncodedMethod method) {
    instantiatedLambdas.add(itf, com.debughelper.tools.r8.shaking.KeepReason.instantiatedIn(method));
  }

  private void markDirectStaticOrConstructorMethodAsLive(
      DexEncodedMethod encodedMethod, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void markVirtualMethodAsLive(DexEncodedMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
    assert method != null;
  ...
  private void markInstanceFieldAsReachable(DexField field, com.debughelper.tools.r8.shaking.KeepReason reason) {
    if (Log.ENABLED) {
  ...
  private void markVirtualMethodAsReachable(DexMethod method, boolean interfaceInvoke,
      com.debughelper.tools.r8.shaking.KeepReason reason) {
        ...
        if (!encodedMethod.accessFlags.isAbstract()) {
          ...
          if (isInstantiatedOrHasInstantiatedSubtype(encodedMethod.method.holder)) {
            if (instantiatedTypes.contains(encodedMethod.method.holder)) {
              markVirtualMethodAsLive(encodedMethod,
                  com.debughelper.tools.r8.shaking.KeepReason.reachableFromLiveType(encodedMethod.method.holder));
            } else {
              ...
              while (!worklist.isEmpty()) {
                ...
                if (instantiatedTypes.contains(current)) {
                  markVirtualMethodAsLive(encodedMethod, com.debughelper.tools.r8.shaking.KeepReason.reachableFromLiveType(current));
                  break;
                }
  ...
  private void markSuperMethodAsReachable(DexMethod method, DexEncodedMethod from) {
    ...
    markMethodAsTargeted(resolutionTarget, com.debughelper.tools.r8.shaking.KeepReason.targetedBySuperFrom(from));
    ...
    if (liveMethods.contains(from)) {
      markMethodAsTargeted(target, com.debughelper.tools.r8.shaking.KeepReason.invokedViaSuperFrom(from));
      if (!target.accessFlags.isAbstract()) {
        markVirtualMethodAsLive(target, com.debughelper.tools.r8.shaking.KeepReason.invokedViaSuperFrom(from));
      }
    }
  }

  public com.debughelper.tools.r8.shaking.ReasonPrinter getReasonPrinter(Set<DexItem> queriedItems) {
    // If no reason was asked, just return a no-op printer to avoid computing the information.
    // This is the common path.
    if (queriedItems.isEmpty()) {
      return com.debughelper.tools.r8.shaking.ReasonPrinter.getNoOpPrinter();
    }
    Map<DexItem, com.debughelper.tools.r8.shaking.KeepReason> reachability = new HashMap<>();
  ...
  public AppInfoWithLiveness traceMainDex(
          RootSetBuilder.RootSet rootSet, ExecutorService executorService, Timing timing) throws ExecutionException {
    ...
    try {
      while (true) {
        ...
        if (numOfLiveItemsAfterProcessing > numOfLiveItems) {
          ...
          RootSetBuilder.ConsequentRootSet consequentRootSet = consequentSetBuilder.runForIfRules(
  ...
  private void markMethodAsKept(DexEncodedMethod target, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void markFieldAsKept(DexEncodedField target, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void markAllLibraryVirtualMethodsReachable(DexClass clazz) {
    ...
    for (DexEncodedMethod encodedMethod : clazz.virtualMethods()) {
      markMethodAsTargeted(encodedMethod, com.debughelper.tools.r8.shaking.KeepReason.isLibraryMethod());
      markVirtualMethodAsReachable(encodedMethod.method, clazz.isInterface(),
          com.debughelper.tools.r8.shaking.KeepReason.isLibraryMethod());
    }
  }

  private void processNewlyLiveMethod(DexEncodedMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
    if (liveMethods.add(method, reason)) {
      ...
      if (superCallTargets != null) {
        for (DexEncodedMethod superCallTarget : superCallTargets) {
          ...
          markMethodAsTargeted(superCallTarget, com.debughelper.tools.r8.shaking.KeepReason.invokedViaSuperFrom(method));
          markVirtualMethodAsLive(superCallTarget, com.debughelper.tools.r8.shaking.KeepReason.invokedViaSuperFrom(method));
        }
      }
  ...
  private void collectProguardCompatibilityRule(com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private void markClassAsInstantiatedWithCompatRule(DexClass clazz) {
    ...
    proguardCompatibilityWorkList.add(
        Action.markInstantiated(clazz, com.debughelper.tools.r8.shaking.KeepReason.dueToProguardCompatibilityKeepRule(rule)));
  ...
  private void markFieldAsKeptWithCompatRule(DexEncodedField field) {
    ...
    proguardCompatibilityWorkList.add(
        Action.markFieldKept(field, com.debughelper.tools.r8.shaking.KeepReason.dueToProguardCompatibilityKeepRule(rule)));
  }
  ...
  private void markMethodAsKeptWithCompatRule(DexEncodedMethod method) {
    ...
    proguardCompatibilityWorkList.add(
        Action.markMethodLive(method, com.debughelper.tools.r8.shaking.KeepReason.dueToProguardCompatibilityKeepRule(rule)));
  }
  ...
  private static class Action {
    ...
    final com.debughelper.tools.r8.shaking.KeepReason reason;

    private Action(Kind kind, DexItem target, DexItem context, com.debughelper.tools.r8.shaking.KeepReason reason) {
      this.kind = kind;
      this.target = target;
    ...
    public static Action markReachableVirtual(DexMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
      return new Action(Kind.MARK_REACHABLE_VIRTUAL, method, null, reason);
    }

    public static Action markReachableInterface(DexMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
    ...
    public static Action markReachableField(DexField field, com.debughelper.tools.r8.shaking.KeepReason reason) {
      return new Action(Kind.MARK_REACHABLE_FIELD, field, null, reason);
    }

    public static Action markInstantiated(DexClass clazz, com.debughelper.tools.r8.shaking.KeepReason reason) {
      return new Action(Kind.MARK_INSTANTIATED, clazz, null, reason);
    }

    public static Action markMethodLive(DexEncodedMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
      return new Action(Kind.MARK_METHOD_LIVE, method, null, reason);
    }

    public static Action markMethodKept(DexEncodedMethod method, com.debughelper.tools.r8.shaking.KeepReason reason) {
      return new Action(Kind.MARK_METHOD_KEPT, method, null, reason);
    }

    public static Action markFieldKept(DexEncodedField field, com.debughelper.tools.r8.shaking.KeepReason reason) {
  ...
  private static class SetWithReason<T> {
    ...
    private final Map<T, com.debughelper.tools.r8.shaking.KeepReason> reasons = Maps.newIdentityHashMap();

    boolean add(T item, com.debughelper.tools.r8.shaking.KeepReason reason) {
      if (items.add(item)) {
    ...
    Map<T, com.debughelper.tools.r8.shaking.KeepReason> getReasons() {
    ...
    public boolean addField(DexField field) {
      ...
      if (target != null) {
        ...
        if (target.field == field) {
          markStaticFieldAsLive(field, com.debughelper.tools.r8.shaking.KeepReason.referencedInAnnotation(annotationHolder));
        }
      } else {
        target = holder.lookupInstanceField(field);
        // There is no dispatch on annotations, so only keep what is directly referenced.
        if (target != null && target.field != field) {
          markInstanceFieldAsReachable(field, com.debughelper.tools.r8.shaking.KeepReason.referencedInAnnotation(annotationHolder));
        }
      }
      return false;
    }
      ...
      if (target != null) {
        ...
        if (target.method == method) {
          markDirectStaticOrConstructorMethodAsLive(
              target, com.debughelper.tools.r8.shaking.KeepReason.referencedInAnnotation(annotationHolder));
        }
      } else {
        target = holder.lookupVirtualMethod(method);
        // There is no dispatch on annotations, so only keep what is directly referenced.
        if (target != null && target.method == method) {
          markMethodAsTargeted(target, com.debughelper.tools.r8.shaking.KeepReason.referencedInAnnotation(annotationHolder));
        }
      }
      return false;
    }
