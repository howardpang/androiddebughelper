...
import com.debughelper.tools.r8.ir.desugar.LambdaClass;
import com.debughelper.tools.r8.ir.desugar.LambdaDescriptor;
import com.debughelper.tools.r8.ir.desugar.SynthesizedLambdaSourceCode;
...
final class LambdaMainMethodSourceCode extends com.debughelper.tools.r8.ir.desugar.SynthesizedLambdaSourceCode {

  LambdaMainMethodSourceCode(com.debughelper.tools.r8.ir.desugar.LambdaClass lambda, DexMethod mainMethod) {
  ...
  protected void prepareInstructions() {
    ...
    com.debughelper.tools.r8.ir.desugar.LambdaClass.Target target = lambda.target;
    ...
    boolean constructorTarget = target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.DIRECT;
    assert !constructorTarget || methodToCall.name == factory().constructorMethodName;

    List<DexType> implReceiverAndArgs = new ArrayList<>();
    if (target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.VIRTUAL || target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.INTERFACE) {
    ...
    assert target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.STATIC
        || target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.VIRTUAL
        || target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.DIRECT
        || target.invokeType == com.debughelper.tools.r8.ir.code.Invoke.Type.INTERFACE;
  ...
  private int addPrimitiveUnboxing(int register, DexType primitiveType, DexType boxType) {
    ...
    add(builder -> builder.addInvoke(com.debughelper.tools.r8.ir.code.Invoke.Type.VIRTUAL,
