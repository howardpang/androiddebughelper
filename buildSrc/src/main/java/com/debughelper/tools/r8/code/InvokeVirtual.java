...
public class InvokeVirtual extends Format35c {
  ...
  public InvokeVirtual(int A, com.debughelper.tools.r8.graph.DexMethod BBBB, int C, int D, int E, int F, int G) {
  ...
  public void buildIR(IRBuilder builder) {
    builder.addInvokeRegisters(Invoke.Type.VIRTUAL, getMethod(), getProto(), A, new int[]{C, D, E, F, G});
  }
