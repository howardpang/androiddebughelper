...
public class R8CommandParser extends BaseCompilerCommandParser {
  ...
  public static void main(String[] args) throws CompilationFailedException {
    com.debughelper.tools.r8.R8Command command = parse(args, Origin.root()).build();
   ...
   */
  public static com.debughelper.tools.r8.R8Command.Builder parse(String[] args, Origin origin) {
    return new R8CommandParser().parse(args, origin, com.debughelper.tools.r8.R8Command.builder());
  }
   ...
   * @return R8 command builder with state set up according to parsed command line.
   */
  public static com.debughelper.tools.r8.R8Command.Builder parse(String[] args, Origin origin, DiagnosticsHandler handler) {
    return new R8CommandParser().parse(args, origin, com.debughelper.tools.r8.R8Command.builder(handler));
  }

  private com.debughelper.tools.r8.R8Command.Builder parse(String[] args, Origin origin, com.debughelper.tools.r8.R8Command.Builder builder) {
