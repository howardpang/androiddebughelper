...
import com.debughelper.tools.r8.code.AddIntLit16;
import com.debughelper.tools.r8.code.AddIntLit8;
import com.debughelper.tools.r8.code.RsubInt;
import com.debughelper.tools.r8.code.RsubIntLit8;
import com.debughelper.tools.r8.code.SubDouble;
import com.debughelper.tools.r8.code.SubDouble2Addr;
import com.debughelper.tools.r8.code.SubFloat;
import com.debughelper.tools.r8.code.SubFloat2Addr;
import com.debughelper.tools.r8.code.SubInt;
import com.debughelper.tools.r8.code.SubInt2Addr;
import com.debughelper.tools.r8.code.SubLong;
import com.debughelper.tools.r8.code.SubLong2Addr;
...
public class Sub extends ArithmeticBinop {
  ...
  public Sub(com.debughelper.tools.r8.ir.code.NumericType type, Value dest, Value left, Value right) {
  ...
  @Override
  public com.debughelper.tools.r8.code.Instruction CreateFloat(int dest, int left, int right) {
    return new SubFloat(dest, left, right);
  }

  @Override
  public com.debughelper.tools.r8.code.Instruction CreateDouble(int dest, int left, int right) {
  ...
  @Override
  public com.debughelper.tools.r8.code.Instruction CreateFloat2Addr(int left, int right) {
    return new SubFloat2Addr(left, right);
  }

  @Override
  public com.debughelper.tools.r8.code.Instruction CreateDouble2Addr(int left, int right) {
  ...
  boolean negativeFitsInDexInstruction(Value value) {
    return type == com.debughelper.tools.r8.ir.code.NumericType.INT &&
        value.isConstant() &&
  ...
  public void buildDex(DexBuilder builder) {
    ...
    if (isTwoAddr(builder.getRegisterAllocator()) || type != com.debughelper.tools.r8.ir.code.NumericType.INT) {
