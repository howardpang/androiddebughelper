...
import com.debughelper.tools.r8.code.PackedSwitch;
import com.debughelper.tools.r8.code.PackedSwitchPayload;
import com.debughelper.tools.r8.code.SparseSwitch;
import com.debughelper.tools.r8.code.SparseSwitchPayload;
...
public class Switch extends JumpInstruction {
  ...
  public Int2ReferenceSortedMap<com.debughelper.tools.r8.ir.code.BasicBlock> getKeyToTargetMap() {
    Int2ReferenceSortedMap<com.debughelper.tools.r8.ir.code.BasicBlock> result = new Int2ReferenceAVLTreeMap<>();
  ...
  public com.debughelper.tools.r8.ir.code.BasicBlock targetBlock(int index) {
  ...
  public void print(CfgPrinter printer) {
    ...
    for (int index : targetBlockIndices) {
      com.debughelper.tools.r8.ir.code.BasicBlock target = getBlock().getSuccessors().get(index);
