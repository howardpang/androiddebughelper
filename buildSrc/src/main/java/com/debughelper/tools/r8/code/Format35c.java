...
public abstract class Format35c extends Base3Format {
  ...
  // A | G | op | BBBB | F | E | D | C
  Format35c(int high, BytecodeStream stream, com.debughelper.tools.r8.graph.IndexedDexItem[] map) {
    super(stream);
    G = (byte) (high & 0xf);
    A = (byte) ((high >> 4) & 0xf);
  ...
  protected Format35c(int A, com.debughelper.tools.r8.graph.IndexedDexItem BBBB, int C, int D, int E, int F, int G) {
