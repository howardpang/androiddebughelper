...
public abstract class Format4rcc extends Base4Format {
  ...
  Format4rcc(int high, BytecodeStream stream, com.debughelper.tools.r8.graph.DexMethod[] methodMap, com.debughelper.tools.r8.graph.DexProto[] protoMap) {
    super(stream);
    this.AA = (short) high;
  ...
  Format4rcc(int firstArgumentRegister, int argumentCount, com.debughelper.tools.r8.graph.DexMethod method, com.debughelper.tools.r8.graph.DexProto proto) {
