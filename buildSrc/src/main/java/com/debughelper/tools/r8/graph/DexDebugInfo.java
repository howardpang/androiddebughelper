...
import com.debughelper.tools.r8.graph.DexDebugEntryBuilder;
...
public class DexDebugInfo extends CachedHashValueDexItem {
  ...
  public com.debughelper.tools.r8.graph.DexDebugEvent[] events;

  public DexDebugInfo(int startLine, DexString[] parameters, com.debughelper.tools.r8.graph.DexDebugEvent[] events) {
    assert startLine >= 0;
  ...
  public List<DexDebugEntry> computeEntries(DexMethod method) {
    com.debughelper.tools.r8.graph.DexDebugEntryBuilder builder = new DexDebugEntryBuilder(startLine, method);
    for (com.debughelper.tools.r8.graph.DexDebugEvent event : events) {
