...
class SpillMove {
  ...
  com.debughelper.tools.r8.ir.regalloc.LiveIntervals from;
  com.debughelper.tools.r8.ir.regalloc.LiveIntervals to;

  public SpillMove(MoveType type, com.debughelper.tools.r8.ir.regalloc.LiveIntervals to, com.debughelper.tools.r8.ir.regalloc.LiveIntervals from) {
    this.type = type;
    this.to = to;
    this.from = from;
    assert to.getRegister() != com.debughelper.tools.r8.ir.regalloc.LiveIntervals.NO_REGISTER;
