...
import com.debughelper.tools.r8.D8CommandParser;
 ...
 *
 * <p>To build a D8Adapter command use the {@link D8Command.Builder} class. For example:
 *
 * <pre>
 ...
 */
@Keep
public final class D8Command extends com.debughelper.tools.r8.BaseCompilerCommand {
  ...
  public static class Builder extends BaseCompilerCommand.Builder<D8Command, Builder> {
    ...
    void validate() {
      ...
      if (getProgramConsumer() instanceof ClassFileConsumer) {
        reporter.error("D8Adapter does not support compiling to Java class files");
      }
      if (getAppBuilder().hasMainDexList()) {
        if (intermediate) {
          reporter.error("Option --main-dex-list cannot be used with --intermediate");
        }
        if (getProgramConsumer() instanceof com.debughelper.tools.r8.DexFilePerClassFileConsumer) {
  ...
  static final String USAGE_MESSAGE = com.debughelper.tools.r8.D8CommandParser.USAGE_MESSAGE;
  ...
  public static Builder parse(String[] args, Origin origin) {
    return com.debughelper.tools.r8.D8CommandParser.parse(args, origin);
  }
