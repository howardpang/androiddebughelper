...
public abstract class Format45cc extends Base4Format {
  ...
  public final byte F;
  public final byte G;
  public com.debughelper.tools.r8.graph.DexMethod BBBB;
  public com.debughelper.tools.r8.graph.DexProto HHHH;

  Format45cc(int high, BytecodeStream stream, com.debughelper.tools.r8.graph.DexMethod[] methodMap, com.debughelper.tools.r8.graph.DexProto[] protoMap) {
    super(stream);
    G = (byte) (high & 0xf);
    A = (byte) ((high >> 4) & 0xf);
  ...
  protected Format45cc(int A, com.debughelper.tools.r8.graph.DexMethod BBBB, com.debughelper.tools.r8.graph.DexProto HHHH, int C, int D, int E, int F, int G) {
  ...
  public void collectIndexedItems(IndexedItemCollection indexedItems,
                                  com.debughelper.tools.r8.graph.DexMethod method, int instructionOffset) {
  ...
  @Override
  public String toSmaliString(com.debughelper.tools.r8.naming.ClassNameMapper naming) {
