 ...
 */
public final class PreloadedClassFileProvider implements com.debughelper.tools.r8.ClassFileResourceProvider {

  private static class ClassDescriptorOrigin extends com.debughelper.tools.r8.origin.Origin {
  ...
  public com.debughelper.tools.r8.ProgramResource getProgramResource(String descriptor) {
    ...
    return com.debughelper.tools.r8.ProgramResource.fromBytes(
        new ClassDescriptorOrigin(descriptor), com.debughelper.tools.r8.ProgramResource.Kind.CF, bytes, Collections.singleton(descriptor));
  }
