...
public class ArrayFilledDataPayloadResolver {
  ...
  private final Map<Integer, com.debughelper.tools.r8.code.FillArrayDataPayload> unresolvedPayload = new HashMap<>();
  ...
  public void addPayloadUser(FillArrayData dex) {
    ...
    if (unresolvedPayload.containsKey(payloadOffset)) {
      com.debughelper.tools.r8.code.FillArrayDataPayload payload = unresolvedPayload.remove(payloadOffset);
      resolve(payload);
    }
  }
