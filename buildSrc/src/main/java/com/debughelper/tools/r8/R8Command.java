...
import com.debughelper.tools.r8.origin.StandardOutOrigin;
...
import com.debughelper.tools.r8.shaking.ProguardConfigurationSourceBytes;
 ...
 */
@Keep
public final class R8Command extends com.debughelper.tools.r8.BaseCompilerCommand {
  ...
  public static class Builder extends BaseCompilerCommand.Builder<R8Command, Builder> {
    ...
    @Override
    public Builder addProgramResourceProvider(com.debughelper.tools.r8.ProgramResourceProvider programProvider) {
    ...
    void validate() {
      ...
      if (getProgramConsumer() instanceof com.debughelper.tools.r8.ClassFileConsumer && isMinApiLevelSet()) {
    ...
    private R8Command makeR8Command() {
      ...
      getAppBuilder().getProgramResourceProviders()
          .stream()
          .map(com.debughelper.tools.r8.ProgramResourceProvider::getDataResourceProvider)
  ...
  private static class EnsureNonDexProgramResourceProvider implements com.debughelper.tools.r8.ProgramResourceProvider {

    final com.debughelper.tools.r8.ProgramResourceProvider provider;
    ...
    public Collection<com.debughelper.tools.r8.ProgramResource> getProgramResources() throws com.debughelper.tools.r8.ResourceException {
      Collection<com.debughelper.tools.r8.ProgramResource> resources = provider.getProgramResources();
