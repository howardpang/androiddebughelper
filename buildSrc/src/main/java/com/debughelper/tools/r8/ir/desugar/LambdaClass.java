...
import com.debughelper.tools.r8.ir.desugar.AccessorMethodSourceCode;
import com.debughelper.tools.r8.ir.desugar.LambdaBridgeMethodSourceCode;
import com.debughelper.tools.r8.ir.desugar.LambdaClassConstructorSourceCode;
import com.debughelper.tools.r8.ir.desugar.LambdaConstructorSourceCode;
...
final class LambdaClass {
  ...
  final com.debughelper.tools.r8.ir.desugar.LambdaRewriter rewriter;
  final DexType type;
  ...
  LambdaClass(com.debughelper.tools.r8.ir.desugar.LambdaRewriter rewriter, DexType accessedFrom,
              DexType lambdaClassType, com.debughelper.tools.r8.ir.desugar.LambdaDescriptor descriptor) {
  ...
  static DexType createLambdaClassType(
          com.debughelper.tools.r8.ir.desugar.LambdaRewriter rewriter, DexType accessedFrom, LambdaDescriptor match) {
    ...
    lambdaClassDescriptor.append(com.debughelper.tools.r8.ir.desugar.LambdaRewriter.LAMBDA_CLASS_NAME_PREFIX);
    ...
    for (DexProto bridgeProto : descriptor.bridges) {
      ...
      methods[index++] =
          new DexEncodedMethod(
              ...
              ParameterAnnotationsList.empty(),
              new SynthesizedCode(
                  new com.debughelper.tools.r8.ir.desugar.LambdaBridgeMethodSourceCode(this, mainMethod, bridgeMethod)));
    }
    return methods;
  }
  ...
  private DexEncodedMethod[] synthesizeDirectMethods() {
    ...
    methods[0] =
        new DexEncodedMethod(
            ...
            DexAnnotationSet.empty(),
            ParameterAnnotationsList.empty(),
            new SynthesizedCode(new com.debughelper.tools.r8.ir.desugar.LambdaConstructorSourceCode(this)));
    ...
    if (stateless) {
      methods[1] =
          new DexEncodedMethod(
              ...
              DexAnnotationSet.empty(),
              ParameterAnnotationsList.empty(),
              new SynthesizedCode(new com.debughelper.tools.r8.ir.desugar.LambdaClassConstructorSourceCode(this)));
    }
    return methods;
  }
  ...
  private Target createInstanceMethodTarget(DexType accessedFrom) {
    ...
    if (!descriptor.needsAccessor(accessedFrom)) {
      return new NoAccessorMethodTarget(com.debughelper.tools.r8.ir.code.Invoke.Type.VIRTUAL);
    }
  ...
  private Target createStaticMethodTarget(DexType accessedFrom) {
    ...
    if (!descriptor.needsAccessor(accessedFrom)) {
      return new NoAccessorMethodTarget(com.debughelper.tools.r8.ir.code.Invoke.Type.STATIC);
    }
  ...
  private Target createConstructorTarget(DexType accessedFrom) {
    ...
    if (!descriptor.needsAccessor(accessedFrom)) {
      return new NoAccessorMethodTarget(com.debughelper.tools.r8.ir.code.Invoke.Type.DIRECT);
    }
  ...
  private Target createInterfaceMethodTarget(DexType accessedFrom) {
    ...
    return new NoAccessorMethodTarget(com.debughelper.tools.r8.ir.code.Invoke.Type.INTERFACE);
  }
  ...
  abstract class Target {
    ...
    final com.debughelper.tools.r8.ir.code.Invoke.Type invokeType;

    Target(DexMethod callTarget, com.debughelper.tools.r8.ir.code.Invoke.Type invokeType) {
  ...
  private final class NoAccessorMethodTarget extends Target {
    ...
    NoAccessorMethodTarget(com.debughelper.tools.r8.ir.code.Invoke.Type invokeType) {
  ...
  private final class StaticLambdaImplTarget extends Target {
    ...
    StaticLambdaImplTarget() {
      super(descriptor.implHandle.asMethod(), com.debughelper.tools.r8.ir.code.Invoke.Type.STATIC);
    }
  ...
  private class InstanceLambdaImplTarget extends Target {
    ...
    InstanceLambdaImplTarget(DexMethod staticMethod) {
      super(staticMethod, com.debughelper.tools.r8.ir.code.Invoke.Type.STATIC);
    }
  ...
  private class ClassMethodWithAccessorTarget extends Target {
    ...
    boolean ensureAccessibility() {
      ...
      DexEncodedMethod accessorEncodedMethod = new DexEncodedMethod(
          ...
          new SynthesizedCode(new com.debughelper.tools.r8.ir.desugar.AccessorMethodSourceCode(LambdaClass.this)));
