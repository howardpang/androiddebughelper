...
public class LambdaRewriter {
  ...
  private void patchInstruction(LambdaClass lambdaClass, IRCode code,
    ...
    // all its usages.
    com.debughelper.tools.r8.ir.code.Value lambdaInstanceValue = invoke.outValue();
    ...
    com.debughelper.tools.r8.ir.code.InvokeDirect constructorCall = new InvokeDirect(
