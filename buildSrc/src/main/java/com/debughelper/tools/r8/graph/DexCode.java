...
import com.debughelper.tools.r8.ir.conversion.DexSourceCode;
...
public class DexCode extends Code {
  ...
  public com.debughelper.tools.r8.ir.code.IRCode buildIR(
    ...
    DexSourceCode source =
        new DexSourceCode(
            this, encodedMethod, null, options.lineNumberOptimization == com.debughelper.tools.r8.utils.InternalOptions.LineNumberOptimization.ON);
  ...
  public IRCode buildInliningIR(
    ...
    DexSourceCode source =
        new DexSourceCode(
            ...
            encodedMethod,
            callerPosition,
            options.lineNumberOptimization == com.debughelper.tools.r8.utils.InternalOptions.LineNumberOptimization.ON);
    IRBuilder builder =
  ...
  @Override
  public String toString(DexEncodedMethod method, com.debughelper.tools.r8.naming.ClassNameMapper naming) {
    ...
    for (Instruction insn : instructions) {
      ...
      com.debughelper.tools.r8.utils.StringUtils.appendLeftPadded(builder, Integer.toString(instructionNumber++), 5);
      builder.append(": ");
  ...
  public static class Try extends DexItem {
    ...
    public String toString() {
      return "["
          + com.debughelper.tools.r8.utils.StringUtils.hexString(startAddress, 2)
          + " .. "
          + com.debughelper.tools.r8.utils.StringUtils.hexString(startAddress + instructionCount - 1, 2)
          + "] -> "
          + handlerIndex;
    }
  ...
  public static class TryHandler extends DexItem {
    ...
    public String toString() {
      ...
      for (TypeAddrPair pair : pairs) {
        ...
        builder.append(" -> ");
        builder.append(com.debughelper.tools.r8.utils.StringUtils.hexString(pair.addr, 2));
        builder.append("\n");
      }
