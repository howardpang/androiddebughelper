 ...
 * com.debughelper.tools.r8.graph.DexAnnotation}s specified in the ParameterAnnotations attribute. In contrast, the {@link
...
public class ParameterAnnotationsList extends DexItem {
  ...
  private final com.debughelper.tools.r8.graph.DexAnnotationSet[] values;
  ...
  private ParameterAnnotationsList() {
    this.values = new com.debughelper.tools.r8.graph.DexAnnotationSet[0];
    this.missingParameterAnnotations = 0;
  }

  public ParameterAnnotationsList(com.debughelper.tools.r8.graph.DexAnnotationSet[] values) {
    this(values, 0);
  }

  public ParameterAnnotationsList(com.debughelper.tools.r8.graph.DexAnnotationSet[] values, int missingParameterAnnotations) {
  ...
  /** Iterate over the {@link com.debughelper.tools.r8.graph.DexAnnotation}s of all parameters. */
  public void forEachAnnotation(Consumer<com.debughelper.tools.r8.graph.DexAnnotation> consumer) {
    for (com.debughelper.tools.r8.graph.DexAnnotationSet parameterAnnotations : values) {
      for (com.debughelper.tools.r8.graph.DexAnnotation annotation : parameterAnnotations.annotations) {
   ...
   * com.debughelper.tools.r8.graph.DexAnnotationSet#empty()} is returned.
   *
   * @param i Index of the parameter in the method prototype.
   */
  public com.debughelper.tools.r8.graph.DexAnnotationSet get(int i) {
    assert i >= 0;
  ...
  public ParameterAnnotationsList keepIf(Predicate<DexAnnotation> filter) {
    com.debughelper.tools.r8.graph.DexAnnotationSet[] filtered = null;
