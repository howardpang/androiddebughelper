...
import static com.debughelper.tools.r8.graph.DexEncodedMethod.CompilationState.PROCESSED_INLINING_CANDIDATE_ANY;
import static com.debughelper.tools.r8.graph.DexEncodedMethod.CompilationState.PROCESSED_INLINING_CANDIDATE_SAME_CLASS;
import static com.debughelper.tools.r8.graph.DexEncodedMethod.CompilationState.PROCESSED_INLINING_CANDIDATE_SAME_PACKAGE;
import static com.debughelper.tools.r8.graph.DexEncodedMethod.CompilationState.PROCESSED_INLINING_CANDIDATE_SUBCLASS;
import static com.debughelper.tools.r8.graph.DexEncodedMethod.CompilationState.PROCESSED_NOT_INLINING_CANDIDATE;
...
import com.debughelper.tools.r8.dex.JumboStringRewriter;
...
public class DexEncodedMethod extends KeyedDexItem<DexMethod> implements AppInfo.ResolutionResult {
  ...
  public com.debughelper.tools.r8.ir.code.IRCode buildIR(AppInfo appInfo, com.debughelper.tools.r8.utils.InternalOptions options, com.debughelper.tools.r8.origin.Origin origin) {
    return code == null ? null : code.buildIR(this, appInfo, options, origin);
  }

  public com.debughelper.tools.r8.ir.code.IRCode buildInliningIRForTesting(
          com.debughelper.tools.r8.utils.InternalOptions options, com.debughelper.tools.r8.ir.code.ValueNumberGenerator valueNumberGenerator) {
    return buildInliningIR(null, options, valueNumberGenerator, null, com.debughelper.tools.r8.origin.Origin.unknown());
  }
  ...
  public void setDexCode(com.debughelper.tools.r8.graph.DexCode code) {
    this.code = code;
  }
  ...
  public String descriptor() {
    return descriptor(com.debughelper.tools.r8.naming.NamingLens.getIdentityLens());
  }
  ...
  public String toSmaliString(ClassNameMapper naming) {
    ...
    builder.append("\n");
    if (code != null) {
      com.debughelper.tools.r8.graph.DexCode dexCode = code.asDexCode();
  ...
  /**
   * Generates a {@link com.debughelper.tools.r8.graph.DexCode} object for the given instructions.
   * <p>
   ...
   */
  private com.debughelper.tools.r8.graph.DexCode generateCodeFromTemplate(
    ...
    return new com.debughelper.tools.r8.graph.DexCode(Math.max(numberOfRegisters, requiredArgRegisters), requiredArgRegisters,
        outRegisters, instructions, new com.debughelper.tools.r8.graph.DexCode.Try[0], new com.debughelper.tools.r8.graph.DexCode.TryHandler[0], null, null);
  }
  ...
  public DexEncodedMethod toEmptyThrowingMethodDex() {
    ...
    com.debughelper.tools.r8.graph.DexCode emptyThrowingCode = generateCodeFromTemplate(1, 0, insn);
  ...
  public DexEncodedMethod toMethodThatLogsError(DexItemFactory itemFactory) {
    MemberNaming.Signature signature = MemberNaming.MethodSignature.fromDexMethod(method);
    ...
    DexMethod logMethod = itemFactory
        .createMethod(itemFactory.createType("Ldebughelper/util/Log;"), proto,
    ...
    com.debughelper.tools.r8.graph.DexCode code;
  ...
  public DexEncodedMethod toForwardingMethod(DexClass holder, DexItemFactory itemFactory) {
    ...
    com.debughelper.tools.r8.ir.code.Invoke.Type type = accessFlags.isStatic() ? com.debughelper.tools.r8.ir.code.Invoke.Type.STATIC : Invoke.Type.SUPER;
    Builder builder = builder(this);
    builder.setMethod(newMethod);
