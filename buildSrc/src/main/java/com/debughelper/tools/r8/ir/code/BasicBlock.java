...
import com.debughelper.tools.r8.graph.DebugLocalInfo.PrintLevel;
...
public class BasicBlock {
  ...
  public boolean consistentBlockInstructions(boolean argumentsAllowed) {
    for (com.debughelper.tools.r8.ir.code.Instruction instruction : getInstructions()) {
  ...
  public void replaceLastInstruction(com.debughelper.tools.r8.ir.code.Instruction instruction) {
    com.debughelper.tools.r8.ir.code.InstructionListIterator iterator = listIterator(getInstructions().size());
    iterator.previous();
  ...
  private LinkedList<com.debughelper.tools.r8.ir.code.Instruction> instructions = new LinkedList<>();
    ...
    if (successors.contains(newBlock)) {
      ...
      if (exit().isGoto()) {
        ...
        if (indexOfNewBlock >= successors.size() - 2 && indexOfOldBlock >= successors.size() - 2) {
          ...
          com.debughelper.tools.r8.ir.code.Instruction instruction = getInstructions().removeLast();
          ...
          for (int i = instruction.inValues().size() - 1; i >= 0; i--) {
            ...
            if (value instanceof StackValue) {
              if (value.definition.isLoad()) {
                ...
                com.debughelper.tools.r8.ir.code.Pop pop = new Pop((StackValue) value);
                pop.setBlock(this);
          ...
          com.debughelper.tools.r8.ir.code.Instruction exit = new Goto();
          exit.setBlock(this);
  ...
  public LinkedList<com.debughelper.tools.r8.ir.code.Instruction> getInstructions() {
    return instructions;
  }
  ...
  public com.debughelper.tools.r8.ir.code.Instruction entry() {
  ...
  public com.debughelper.tools.r8.ir.code.Instruction exceptionalExit() {
    assert hasCatchHandlers();
    ListIterator<com.debughelper.tools.r8.ir.code.Instruction> it = listIterator(instructions.size());
    while (it.hasPrevious()) {
      com.debughelper.tools.r8.ir.code.Instruction instruction = it.previous();
  ...
  public void clearUserInfo() {
    phis = null;
    instructions.forEach(com.debughelper.tools.r8.ir.code.Instruction::clearUserInfo);
  }
  ...
  public void add(com.debughelper.tools.r8.ir.code.Instruction next) {
    assert !isFilled();
  ...
  private static boolean allPredecessorsDominated(BasicBlock block, com.debughelper.tools.r8.ir.code.DominatorTree dominator) {
  ...
  public void addPhiMove(Move move) {
    ...
    // exit instruction?
    com.debughelper.tools.r8.ir.code.Instruction branch = exit();
    instructions.set(instructions.size() - 1, move);
    instructions.add(branch);
  }

  public void setInstructions(LinkedList<com.debughelper.tools.r8.ir.code.Instruction> instructions) {
  ...
  public void removeInstructions(List<Integer> toRemove) {
    if (!toRemove.isEmpty()) {
      LinkedList<com.debughelper.tools.r8.ir.code.Instruction> newInstructions = new LinkedList<>();
      int nextIndex = 0;
   ...
   */
  public void removeInstruction(com.debughelper.tools.r8.ir.code.Instruction toRemove) {
   ...
   */
  public static BasicBlock createIfBlock(int blockNumber, If theIf, com.debughelper.tools.r8.ir.code.Instruction instruction) {
    BasicBlock block = new BasicBlock();
  ...
  public static BasicBlock createRethrowBlock(com.debughelper.tools.r8.ir.code.IRCode code, Position position) {
    BasicBlock block = new BasicBlock();
    com.debughelper.tools.r8.ir.code.MoveException moveException =
        new com.debughelper.tools.r8.ir.code.MoveException(new Value(code.valueNumberGenerator.next(), ValueType.OBJECT, null));
    moveException.setPosition(position);
    com.debughelper.tools.r8.ir.code.Throw throwInstruction = new Throw(moveException.outValue);
  ...
  private boolean verifyNoValuesAfterThrowingInstruction() {
    if (hasCatchHandlers()) {
      ListIterator<com.debughelper.tools.r8.ir.code.Instruction> iterator = listIterator(instructions.size());
  ...
  public com.debughelper.tools.r8.ir.code.InstructionListIterator listIterator() {
    return new BasicBlockInstructionIterator(this);
  }

  public com.debughelper.tools.r8.ir.code.InstructionListIterator listIterator(int index) {
  ...
  public int splitCriticalExceptionEdges(
    ...
    com.debughelper.tools.r8.ir.code.MoveException move = null;
    ...
    for (BasicBlock predecessor : predecessors) {
      ...
      if (hasMoveException) {
        ...
        values.add(value);
        com.debughelper.tools.r8.ir.code.MoveException newMove = new MoveException(value);
