...
public class DescriptorUtils {
  ...
  public static String descriptorToInternalName(String descriptor) {
    switch (descriptor.charAt(0)) {
      ...
      default:
        throw new com.debughelper.tools.r8.errors.Unreachable("Not array or class type");
    }
  }
  ...
  public static String guessTypeDescriptor(String name) {
    assert name != null;
    assert name.endsWith(FileUtils.CLASS_EXTENSION) :
        "Name " + name + " must have " + FileUtils.CLASS_EXTENSION + " suffix";
