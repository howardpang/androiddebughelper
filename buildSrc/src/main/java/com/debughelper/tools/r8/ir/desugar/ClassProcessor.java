...
final class ClassProcessor {
  ...
  private final com.debughelper.tools.r8.ir.desugar.InterfaceMethodRewriter rewriter;
  ...
  private DexEncodedMethod addForwardingMethod(DexEncodedMethod defaultMethod, DexClass clazz) {
    ...
    // NOTE: Never add a forwarding method to methods of classes unknown or coming from debughelper.jar
