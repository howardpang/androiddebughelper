...
public class BasicBlockIterator implements ListIterator<BasicBlock> {
  ...
  protected final com.debughelper.tools.r8.ir.code.IRCode code;
  protected final ListIterator<BasicBlock> listIterator;
  protected BasicBlock current;

  protected BasicBlockIterator(com.debughelper.tools.r8.ir.code.IRCode code) {
    this.code = code;
  ...
  public void remove() {
    ...
    Iterator<com.debughelper.tools.r8.ir.code.Instruction> iterator = current.iterator();
