...
public final class CaptureSignature {
  ...
  public static IntList getReverseCaptureMapping(com.debughelper.tools.r8.graph.DexType[] types) {
    if (types.length == 0) {
      return EMPTY_LIST;
    }
  ...
  public static com.debughelper.tools.r8.graph.DexType fieldType(DexItemFactory factory, String capture, int index) {
    switch (capture.charAt(index)) {
      ...
      default:
        throw new com.debughelper.tools.r8.errors.Unreachable("Invalid capture character: " + capture.charAt(index));
    }
  }
  ...
  public static String getCaptureSignature(com.debughelper.tools.r8.graph.DexEncodedField[] fields) {
  ...
  public static int mapFieldIntoCaptureIndex(
          String capture, com.debughelper.tools.r8.graph.DexEncodedField[] lambdaFields, DexField fieldToMap) {
