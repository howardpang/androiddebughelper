...
public abstract class Format22c extends Base2Format {
  ...
  public final byte A;
  public final byte B;
  public com.debughelper.tools.r8.graph.IndexedDexItem CCCC;

  // vB | vA | op | [type|field]@CCCC
  /*package*/ Format22c(int high, BytecodeStream stream, com.debughelper.tools.r8.graph.IndexedDexItem[] map) {
    super(stream);
    A = (byte) (high & 0xf);
    B = (byte) ((high >> 4) & 0xf);
  ...
  /*package*/ Format22c(int A, int B, com.debughelper.tools.r8.graph.IndexedDexItem CCCC) {
