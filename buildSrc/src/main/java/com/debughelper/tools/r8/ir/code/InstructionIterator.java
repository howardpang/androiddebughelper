...
import com.debughelper.tools.r8.ir.code.NextUntilIterator;

public interface InstructionIterator extends NextUntilIterator<com.debughelper.tools.r8.ir.code.Instruction> {
  /**
   * Replace the current instruction (aka the {@link com.debughelper.tools.r8.ir.code.Instruction} returned by the previous call to
   ...
   */
  void replaceCurrentInstruction(com.debughelper.tools.r8.ir.code.Instruction newInstruction);
