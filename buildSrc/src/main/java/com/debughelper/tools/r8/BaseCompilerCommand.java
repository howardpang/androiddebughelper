 ...
 * debughelper application (and optional main-dex list) also configure compilation output, compilation
 * mode and min API level.
 *
 * <p>For concrete builders, see for example {@link D8Command.Builder} and {@link
 * com.debughelper.tools.r8.R8Command.Builder}.
 */
@Keep
public abstract class BaseCompilerCommand extends BaseCommand {
   ...
   *
   * @param <C> Command the builder is building, e.g., {@link com.debughelper.tools.r8.R8Command} or {@link D8Command}.
  ...
  public abstract static class Builder<C extends BaseCompilerCommand, B extends Builder<C, B>>
     ...
     * <li>if a separate desugar tool has been used prior to compiling with D8Adapter.
     * </ul>
     *
