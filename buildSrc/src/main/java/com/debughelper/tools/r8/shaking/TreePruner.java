...
import com.debughelper.tools.r8.shaking.UsagePrinter;
...
public class TreePruner {
  ...
  private final com.debughelper.tools.r8.shaking.UsagePrinter usagePrinter;
  ...
  public TreePruner(
    ...
    this.usagePrinter = options.proguardConfiguration.isPrintUsage()
        ? new com.debughelper.tools.r8.shaking.UsagePrinter() : com.debughelper.tools.r8.shaking.UsagePrinter.DONT_PRINT;
  }
      ...
      if (!appInfo.liveTypes.contains(clazz.type)) {
        ...
        if (!appInfo.instantiatedTypes.contains(clazz.type) &&
          ...
          if (clazz.accessFlags.isFinal()) {
            // We cannot mark this class abstract, as it is final (not supported on debughelper).
